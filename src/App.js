    ...
    return (
      <div className="App">
        <div className="Arkanoid-Board" style={{width: `${BOARD_WIDTH}px`, height: `${BOARD_HEIGHT}px`}}>
          ...
          <div className='Signature' style={{position: 'absolute', top: `${BOARD_HEIGHT-20}px`, left: `${BOARD_WIDTH - 210}px`,color: 'white'}}>&copy; 2023 by Swapnil</div>
